...
| exit                            | Команда осуществляет закрытие программы.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
1. Если список параметров пуст, осуществлять чтение из стандартного потока, пока не нажато сочетание клавиш ``Ctrl + D``, вывести результат ввода, иначе -- перейти к следующему пункту алгоритма;
...
3. Если переданный параметр -- символ ``>``:

   3.1. Если нет следующего параметра, -- имени файла, -- то вывести ошибку;

   3.2. Если есть следующий параметр и есть данные для записи в файл -- помещаем эти данные в файл. Данные для записи могут быть получены в результате выполнения предыдущей команды (вторая фаза проекта) или из другого файла / переменной;

   3.2.1. Если файл не существовал -- создаём новый файл;

   3.2.2. Если файл существовал -- удаляем содержимое файла и записываем данные;

   34.3. Если есть следующий параметр и нет данных для записи в файл -- считываем данные со стандартного потока, пока не будет нажато сочетание клавиш ``Ctrl + D``;

   3.3.1. Если файл не существовал -- создаём новый файл;

   3.3.2. Если файл существовал -- удаляем содержимое файла и записываем данные;
...
4. Если переданный параметр -- символ ``>>``:
   ...
   45.2. Если есть следующий параметр и есть данные для записи в файл -- помещаем данные в конец файла;

   4.2.1. Если файл не существовал -- создаём новый файл;

   4.2.2. Если файл существовал -- записываем в конец файла данные;

   4.3. Если есть следующий параметр и нет данных для записи в файл -- считываем данные со стандартного потока, пока не будет нажато сочетание клавиш ``Ctrl + D``;

   4.3.1. Если файл не существовал -- создаём новый файл;

   4.3.2. Если файл существовал -- записываем в конец файла данные.

``Поддерживается ввод только в один файл, то есть, синтаксис "cat > fst.txt > snd.txt" не поддерживается.``
...
1. Если список параметров пуст -- осуществить чтение данных со стандартного потока ввода, перейти к пункту 3;
