...
3. Если переданный параметр -- символ ``>``:
   ...
   4.1. Если нет следующего параметра, -- имени файла, -- то вывести ошибку;

   4.2. Если есть следующий параметр и есть данные для записи в файл -- помещаем эти данные в файл. Данные для записи могут быть получены в результате выполнения предыдущей команды (вторая фаза проекта) или из другого файла / переменной;

   4.2.1. Если файл не существовал -- создаём новый файл;

   4.2.2. Если файл существовал -- удаляем содержимое файла и записываем данные;
   ...
   4.3.2. Если файл существовал -- удаляем содержимое файла и записываем данные;
...
4. Если переданный параметр -- символ ``>>``:
   ...
   5.2. Если есть следующий параметр и есть данные для записи в файл -- помещаем данные в конец файла;

   5.2.1. Если файл не существовал -- создаём новый файл;

   5.2.2. Если файл существовал -- записываем в конец файла данные;

   5.3. Если есть следующий параметр и нет данных для записи в файл -- считываем данные со стандартного потока, пока не будет нажато сочетание клавиш ``Ctrl + D``;

   5.3.1. Если файл не существовал -- создаём новый файл;
